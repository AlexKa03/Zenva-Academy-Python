...
tk_colors = [
    ...
    "AntiqueWhite2", "AntiqueWhite3", "AntiqueWhite4", "agua", "aquamarine", 
    "aquamarine1", "aquamarine2", "aquamarine3", "aquamarine4", "azure", 
    "azure1", "azure2", "azure3", "azure4", "beige", "bisque", "bisque1", 
    "bisque2", "bisque3", "bisque4", "black", "blanched almond", "BlanchedAlmond", 
    ...
    "cornsilk", "cornsilk1", "cornsilk2", "cornsilk3", "cornsilk4", "crymson", 
    "cyan", "cyan1", "cyan2", "cyan3", "cyan4", "dark blue", "dark cyan", 
    ...
    "forest green", "ForestGreen", "fuchsia", "gainsboro",
    "gold", "gold1", "gold2", "gold3", "gold4", "goldenrod", 
    "goldenrod1", "goldenrod2", "goldenrod3", "goldenrod4", "gray", "gray0", 
    ...
    "green", "green yellow", "green1", "green2", "green3", "green4", 
    "GreenYellow", "grey", "grey0", "grey1", "grey2", "grey3", "grey4", "grey5", 
    "grey6", "grey7", "grey8", "grey9", "grey10", "grey11", "grey12", "grey13", 
    ...
    "grey77", "grey78", "grey79", "grey80", "grey81", "grey82", "grey83", 
    ...
    "khaki4", "lavender", "lavender blush", "LavenderBlush", "LavenderBlush1", 
    ...
    "light sea green", "light sky blue", "light slate blue", "light slate gray", 
    ...
    "LightYellow1", "LightYellow2", "LightYellow3", "LightYellow4", "lime", 
    "lime green", "LimeGreen", "linen", "magenta", "magenta1", "magenta2", 
    ...
    "navy blue", "NavyBlue", "old lace", "OldLace", "olive", "olive drab", 
    ...
    "orchid", "orchid1", "orchid2", "orchid3", "orchid4", "pale goldenrod", 
    ...
    "PaleVioletRed3", "PaleVioletRed4", "papaya whip", "PapayaWhip", 
    "peach puff", "PeachPuff", "PeachPuff1", "PeachPuff2", "PeachPuff3", 
    "PeachPuff4", "peru", "pink", "pink1", "pink2", "pink3", "pink4", "plum", 
    "plum1", "plum2", "plum3", "plum4", "powder blue", "PowderBlue", "purple", 
    "purple1", "purple2", "purple3", "purple4", "red", "red1", "red2", "red3", 
    "red4", "rosy brown", "RosyBrown", "RosyBrown1", "RosyBrown2", "RosyBrown3", 
    "RosyBrown4", "royal blue", "RoyalBlue", "RoyalBlue1", "RoyalBlue2", 
    "RoyalBlue3", "RoyalBlue4", "saddle brown", "SaddleBrown", "salmon", 
    "salmon1", "salmon2", "salmon3", "salmon4", "sandy brown", "SandyBrown", 
    "sea green", "SeaGreen", "SeaGreen1", "SeaGreen2", "SeaGreen3", 
    ...
    "spring green", "SpringGreen", "SpringGreen1", 
    "SpringGreen2", "SpringGreen3", "SpringGreen4", "steel blue", "SteelBlue", 
    "SteelBlue1", "SteelBlue2", "SteelBlue3", "SteelBlue4", "tan", "tan1", 
    "tan2", "tan3", "tan4", "teal", "thistle", "thistle1", "thistle2", 
    ...
    "wheat3", "wheat4", "yellow", "yellow green", "yellow1", "yellow2",
...
def inflate_balloon():
    ...
    diameter += random.randrange(1, 10)
    draw_balloon()

    if diameter >= pop_diameter:
        clear()
        diameter = 40
        write("POP!", font=("Arial", 10, "normal"), align="center")
        color(random.choice(tk_colors))

def deflate_ballon():
    global diameter

    defalation_amount = random.randrange(1, 10)

    if diameter > 0 and diameter - defalation_amount > 0:
        diameter -= defalation_amount
        clear()
        draw_balloon()
